...
struct BatchStockResult {

	/* 0-成功 1-失败 */
	1:result.Result result,
	
	2:list<StockInfo> stockInfos
}
...
service StockServ{
	...
	/* 批量查询库存接口, */
	BatchStockResult batchQueryStock(1: BatchQueryParam param)
	/* 锁定库存接口 */
